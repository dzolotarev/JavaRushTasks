...
public class Solution {
    ...
    static void addUser(User user) {
        ...
        if (statusSetName == -1) System.out.println(CANNOT_BE_NULL);
        else if (statusSetName == -2) System.out.println(CANNOT_BE_EMPTY);
        else if (statusSetName == -3) System.out.println(CANNOT_CONTAIN_DIGIT);
        else if (statusSetName != 0) System.out.println(UNKNOWN_ERROR);
        else user.setName(name);

        int statusSetAge = user.setAge(age);
        if (statusSetAge == -1) System.out.println(CANNOT_BE_NEGATIVE);
        else if (statusSetAge == -2) System.out.println(CANNOT_BE_TOO_BIG);
        else if (statusSetAge != 0) System.out.println(UNKNOWN_ERROR);
    ...
    static void findUserIndex(User user) {
        int statusIndexOfUser = users.indexOf(user);
        if (statusIndexOfUser == -1) System.out.printf(NOT_FOUND, user.getName());
