...
public class CustomTree_origin extends AbstractList<String> implements Cloneable, Serializable {
    ...
    public boolean equals(Object o) {
        ...
        CustomTree_origin customTree = (CustomTree_origin) o;
    ...
    private class SolutionIterator implements Iterator<String> {
        ...
        public synchronized void remove() {
            ...
            CustomTree_origin.this.remove(list.get(lastReturned).elementName);
            index = lastReturned;
            lastReturned = -1;
            list = queue;
        }
